...
def menu():
    ...
    print(" Name        : %s"%(name))
    print(" ID          : %s"%(id))
    print(" Ttl. Lahir  : %s"%(ttl))
    print('──────────────────────────────────────────')
    print(" [1]. crack form public id")
    print(" [2]. check cp account options")
    print(" [3]. see crack result")
    print(" [4]. setting user agent")
    print(" [5]. logout (remove token)")
    print('──────────────────────────────────────────')
...
def gantiua():
	...
	if ajg in[""]:
		...
		try:
			...
			zedd.close()
			print('──────────────────────────────────────────')
			print(" [✓] LOGING HU GYAA LOWDE")
			input(" [*] ENTER KR LOWDE PECHYE JANY K LIYE")
			menu()
		except KeyError:
			exit()
### CEK OPSI ###
def cekopsi():
	...
	ubahpw()
	print('\n [!] you can turn off cellular data to pause the check process')
	print('──────────────────────────────────────────')
	...
	input(" [*] LOWDE ENTER KR")
	time.sleep(1)
	menu()

def ubahpw():
	print('──────────────────────────────────────────')
	pw=input(" [?] change password tap yes?[Y/t]: ")
	if pw == "Y" or pw == "y":
		ubahP.append("y")
...
def cekhasil():
	print('──────────────────────────────────────────')
	print(' [1]. see the crack OK ')
	print(' [2]. see the crack CP ')
	print('──────────────────────────────────────────')
	anjg = input(' [?] pilih : ')
	if anjg == '':
		menu()
...
def otomatis():
	...
	if ask=="":
		...
		print(' [+] OK result saved to -> ok.txt')
		print(' [+] Cp result saved to -> cp.txt')
		print('──────────────────────────────────────────')
